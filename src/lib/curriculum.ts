...
export const curriculum: Area[] = [
  {
    ...
    order: 1,
    lessons: [
      { slug: "vectors-and-frames", title: "Vectors and frames", order: 1, status: "draft", difficulty: "intro", prerequisites: [] },
      { slug: "rotations-2d", title: "Rotations in 2D", order: 2, status: "draft", difficulty: "intro", prerequisites: ["vectors-and-frames"] },
